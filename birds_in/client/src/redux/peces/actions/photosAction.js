...
export const saveImageFtp = (formData) => {
    return async (dispatch) => {
      try {
        const response = await axios.post('peces/upload_image', formData, {
          headers: {
...
export const UpdateDestacada = (formData) => {
    return async (dispatch) => {
      try {
        const response = await axios.post('peces/upload_destacada', formData, {
          headers: {
            'Content-Type': 'multipart/form-data', // Asegúrate de establecer el tipo de contenido correcto
          },
        });
  ...
  export const sendPhotosDelete = (ids, urls) => {
    ...
    return async (dispatch) => {
        try {
            ...
            const response = await axios.delete('/peces/borrar_fotos', requestData)
...
export const sendCoverPhoto = (id, idRegistro) => {
    ...
    return async (dispatch) => {
        try {
            ...
            const response = axios.put('/peces/foto_portada', requestData )
            const data = response.data
            return data
        } catch (error) {
            console.error("Error al obtener los datos:", error)
...
export const saveOrderPhotos = (arrayImages) => {
  ...
  return async (dispatch) => {
    try {
      const response = axios.post('/peces/guardar_orden_images', { arrayImages })
      const data = response.data
      return data
    } catch (error) {
      console.error("Error al obtener los datos:", error)
