...
//components
import { IndexD } from '../../components/Dashboard/Peces/IndexD'
  ...
  return (
    <React.Fragment>
      ...
      <Grid
        ...
        alignItems="center"
        sx={{
          background: `url(${allCustom.background_update_fish}) center/cover no-repeat fixed`,
