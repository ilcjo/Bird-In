...
//redux
import { actualizarRegistro, deleteRegistro, getInfoForUpdate } from '../../../redux/insectos/actions/crudAction';
import { UpdateImage } from '../../../redux/insectos/actions/photosAction';
import { clasesFamilia, clasesGrupo } from '../../../redux/insectos/actions/fetchOptions';
...
export const UpdateForm = ({ isEnable, changeTab, showUpdate, showSearch, selected, changeImagenExist }) => {
    ...
    const initialCreateData = {
        grupo: infoForUpdate.grupos_insecto || null,
        familia: infoForUpdate.familias_insecto || null,
        pais: infoForUpdate.paises || [],
        zona: infoForUpdate.zonasInsectos || [],
        ...
        id: infoForUpdate.id_insecto || 0,
        urlImagen: infoForUpdate.imagenes_insectos || [],
    }
