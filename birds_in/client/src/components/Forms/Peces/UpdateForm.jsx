...
//redux
import { actualizarRegistro, deleteRegistro, getInfoForUpdate } from '../../../redux/peces/actions/crudAction';
import { UpdateImage } from '../../../redux/peces/actions/photosAction';
import { clasesFamilia, clasesGrupo } from '../../../redux/peces/actions/fetchOptions';
...
export const UpdateForm = ({ isEnable, changeTab, showUpdate, showSearch, selected, changeImagenExist }) => {
    ...
    const initialCreateData = {
        ...
        id: infoForUpdate.id_pez || 0,
        urlImagen: infoForUpdate.imagenes_peces || [],
    }
    ...
    const handleDeleteRegistro = async () => {
        try {
            ...
            await dispatch(deleteRegistro(infoForUpdate.id_pez));
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            if (imageUrl) {
                ...
                dispatch(getInfoForUpdate(infoForUpdate.id_pez));
                changeImagenExist();
            } else {
                setSnackBarMessage('El Registro se ha Actualizado correctamente.');
                dispatch(getInfoForUpdate(infoForUpdate.id_pez));
