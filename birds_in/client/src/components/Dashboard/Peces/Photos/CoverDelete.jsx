...
//redux
import { saveOrderPhotos, sendCoverPhoto, sendPhotosDelete } from '../../../../redux/peces/actions/photosAction';
...
export const CoverDelete = ({
    ...
    React.useEffect(() => {
        if (infoForUpdate?.imagenes_peces) {
            setImages(infoForUpdate.imagenes_peces);
        }
    }, [infoForUpdate?.imagenes_peces]);
