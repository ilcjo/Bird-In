...
import { saveOrderPhotos } from '../../../../redux/reptiles/actions/photosAction';

const ImageDragContainer = ({ images, handleImageClick, handleSetAsCover, handleDeleteCheckBox,
    loading, backDrop, snackBar, messageBar, errorMessage, errorBar, idRegistro
}) => {
    ...
    const saveOrderToDB = async () => {
        ...
        try {
            ...
            await delay(2000);
            await dispatch(getInfoForUpdate(idRegistro));
