...
export const IndexTabsCreate = ({ isEnable, changeTab, showUpdateBird, showSearchBird, selectedBird, history }) => {
            ...
            <Box>
                {selectedTab === 0 && (
                    <React.Fragment>
                        ...
                        <CreateBird changeTab={changeTab} showUpdateBird={showUpdateBird}
