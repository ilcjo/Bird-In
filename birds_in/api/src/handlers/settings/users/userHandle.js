const { saveRegister, getAllUsersDb, changeApprovedStatus, deleteCompleteU, verifyTokenDb, saveTokenToDatabase, updatePass, updatePassDb } = require("../../../controllers/settings/users/userController")
const bcrypt = require('bcrypt');
const passport = require('passport');
const { generateToken, generateTokenRecoverEmail } = require("../../../config/passport");
const { sendWelcomeEmail, sendApprovalEmail, sendEmailRecoverPass } = require("../../../services/emailService");
